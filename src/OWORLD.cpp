...
short World::get_unit_recno(int xLoc, int yLoc, int mobileType)
{
...
void World::set_unit_recno(int xLoc,int yLoc, int mobileType, int newCargoRecno)
{
	if( mobileType==UNIT_AIR )
...
//
int World::distance_rating(int xLoc1, int yLoc1, int xLoc2, int yLoc2)
{
